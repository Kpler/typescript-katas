...
describe("The complex password validator for iteration two validation 3", () => {
    ...
    it.each([
        ...
        ['should not miss a capital letter', '_charblahblahblah', {result : false, message: "Wrong password"}],
        ['should not miss a lower case letter', '_CHARBLAHBLAHBLAH', {result : false, message: "Wrong password"}],
        ['should not miss a underscore', 'Charblahblahblah', {result : false, message: "Wrong password"}],
